...
def resnet152_model(weights_path=None, input_size = 224, include_top = True):
    ...
    if K.image_dim_ordering() == 'tf':
        bn_axis = 3
        img_input = Input(shape=(input_size, input_size, 3), name='data')
    else:
        bn_axis = 1
        img_input = Input(shape=(3, input_size, input_size), name='data')
